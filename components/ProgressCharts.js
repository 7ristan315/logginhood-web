...
function TargetFaceSVG({ bars, total }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row-reverse", alignItems: "center", gap: 24, flexWrap: "wrap", justifyContent: "center", width: "min(94vw, 840px)", position: "relative", left: "50%", transform: "translateX(-50%)" }}>
