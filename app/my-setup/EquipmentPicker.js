...
export default function EquipmentPicker({ category, value, onChange, placeholder }) {
  ...
  const dropStyle = { position: "absolute", top: "100%", left: 0, right: 0, maxHeight: 280, overflowY: "auto", background: "var(--background)", border: "1px solid var(--border)", borderRadius: 8, zIndex: 9999, marginTop: 2, boxShadow: "0 8px 24px rgba(0,0,0,0.3)" };
